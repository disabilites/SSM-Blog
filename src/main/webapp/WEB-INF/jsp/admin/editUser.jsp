...
<div class="page-wrapper">
    ...
    <div class="main-container">
        ...
        <div class="content">
            <form id="register" action="/admin/edit-user-finish" method="post">
                <div class="register-body">

                    <div class="form-group">
                        <label>用户名</label>
                        <input type="text" name="name" class="form-control" disabled="disabled" value="${user.name}">
                    </div>
                    ...
                    <div class="register-footer">
                        <button type="submit" class="button button-glow button-rounded button-primary" disabled="disabled">提交</button>
                        <button formaction="/admin/users" type="reset" class="button button-glow button-rounded button-caution">取消</button>
                    </div>
