                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <c:forEach var="article" items="${articles}">
                                        <tr>
                                            ...
                                            <td>${article.state}</td>
                                            <td>
                                                <a href="/admin/edit-article?id=${article.id}" class="button button-glow button-rounded button-primary">修改</a>
                                                <a href="/admin/delete-article?id=${article.id}" class="button button-glow button-rounded button-caution">删除</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                    ...
                                    <c:forEach var="article" items="${articles}">
                                        <c:if test="${article.state eq '已发布'}">
                                            <tr>
                                                ...
                                                <td><fmt:formatDate value="${article.date}" pattern="yyyy-MM-dd"/> </td>
                                                <td>
                                                    <a href="/admin/edit?id=${article.id}" class="button button-glow button-rounded button-primary delete">修改</a>
                                                    <a href="/admin/delete?id=${article.id}" class="button button-glow button-rounded button-caution delete">删除</a>
                                                </td>
                                            </tr>
                                        </c:if>
                                    </c:forEach>
                                ...
                                <table class="table hide">
                                    ...
                                    <tbody>
                                    <c:forEach var="article" items="${articles}">
                                        <c:if test="${article.state eq '草稿'}">
                                            <tr>
                                                <td>${article.title}</td>
                                                <td>${article.classification}</td>
                                                <td><fmt:formatDate value="${article.date}" pattern="yyyy-MM-dd"/> </td>
                                                <td>
                                                    <a href="/admin/edit?id=${article.id}" class="button button-glow button-rounded button-primary">修改</a>
                                                    <a href="/admin/delete?id=${article.id}" class="button button-glow button-rounded button-caution">删除</a>
                                                </td>
                                            </tr>
                                        </c:if>
                                    </c:forEach>
