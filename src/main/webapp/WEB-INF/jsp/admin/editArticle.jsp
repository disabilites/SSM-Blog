...
<div class="main-container">
    ...
    <div class="content">
        <form method="post" action="/admin/edit-article-finish?id=${article.id}">
            <header>
                <input type="text" placeholder="在此输入标题" name="article_title" class="title" value="${article.title}">
                <button type="submit" class="button button-raised button-pill button-inverse">发布</button>
                <a href="/admin/articles" class="button button-raised button-pill button-inverse">取消</a>
                <br>
                <input type="text" placeholder="在此输入标题" name="article_tag" class="classification" value="${article.classification}">
            </header>
            <div class = "content-wrap">
            <textarea id="markdown" name="content_md" class="content_md" onkeyup="convert()">${article.context_md}</textarea>
